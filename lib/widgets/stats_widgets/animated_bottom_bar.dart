...
class AnimatedBottomBar extends StatefulWidget {
  ...
  AnimatedBottomBar(
      {Key key, this.barItems,
        this.animationDuration = const Duration(milliseconds: 500),
        this.elevation,this.onItemTap, this.currBarItem}) : super(key: key);
...
class AnimatedBarItem extends StatefulWidget {
  ...
  AnimatedBarItem({Key key, this.isSelected, this.thisItemIndex,this.barItem,this.currBarItem,this.animationDuration, this.elevation, this.onItemTap}) : super(key: key);
  @override
