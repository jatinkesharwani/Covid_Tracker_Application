...
class VirusDetailsScreen extends StatelessWidget with NavigationStates {
  ...
  static List<Map<String, String>> details = [
    ...
    {
      "detail": "Origin",
      "desc": "The virus is believed to have originated late last year in a food market" " in the Chinese city of Wuhan that was illegally selling wildlife. Health" " experts think it may have originated in bats and then passed to humans," " possibly via another animal species.\n\nThere are also reports that the " "intermediate host could be pangolins."
    },
    {
      "detail": "How dangerous is it?",
      "desc": "Coronavirus infections have a several of symptoms, including fever, " "cough, shortness of breath, and breathing difficulties.\n\nIt is unclear how deadly" " the new virus is. Although severe cases can cause pneumonia and death, there may" " be many cases of milder disease going undetected. Many of those who have died had" " prior medical conditions or were elderly with weakened immune systems.",
    },
    {
      "detail": "How is it transmitted?",
      "desc": "The new coronavirus can be transmitted from person to person, although it is" " not clear how easily that happens.\n\nTransmission happens most likely through close contact" " with an infected person via particles in the air from coughing or sneezing, or by " "someone touching an infected person or object with the virus on it and then touching" " their mouth, nose or eyes.",
    },
    {
      "detail": "Are there any vaccines for the coronavirus?",
      "desc": "To date, there is no specific medicine recommended to prevent or treat the new coronavirus." "However, those infected with the virus should receive appropriate care to relieve" " and treat symptoms\n\nSome specific treatments are under investigation, and will be tested through" " clinical trials. Some doctors are trying out a potent brew of anti-retroviral and flu" " drugs to treat those infected, but the science is inconclusive as to whether they " "are effective.",
    },
  ];
