  ...
  List<Map<String, String>> myths = [
    {
      ...
      "desc": "It's a respiratory virus which spreads primarily " "through droplets of an infected person's coughs or sneezes," " saliva or discharge from the nose.",
    ...
    },
    {
      ...
      "desc":
          "There is no reason to believe that hot weather can kill the new coronavirus" " or other diseases. It can be transmitted in any climate.",
      "imgPath": "assets/myths/hot.png",
    },
    {
      "myth": "Garlic DOES NOT protect against infection from the coronavirus",
      "desc": "Garlic may have some anti microbial properties." " However, no evidence suggests that garlic" " can protect people against COVID-19 virus.",
      "imgPath": "assets/myths/garlic.png",
    },
    {
      "myth": "Antibiotics DO NOT work against viruses, only bacteria",
      "desc": "The new coronavirus (2019-nCoV) is a virus and, therefore, " "antibiotics should not be used as a means of prevention or treatment.",
    ...
    },
    {
      ...
      "desc": "It can infect people of any age, including children." " However, older adults and individuals with prior health conditions" " are more likely to become severely ill.",
